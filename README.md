...
- [x] Describe Middleware?
        Functions that are done during server actions. Executed in order.

- [x] Describe a Resource?
        Any item stored, sent, or received from a server/api. The data used.

- [x] What can the API return to help clients know if a request was successful?
        Status codes and sometimes messages

- [x] How can we partition our application into sub-applications?
        Using routing to break up the responsibilities for the api
